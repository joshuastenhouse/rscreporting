...
<#
.SYNOPSIS
A Rubrik Security Cloud (RSC) Reporting Module Function returning a list of all files matched/found by a threat hunt.
...
.EXAMPLE
Get-RSCThreatHuntMatches -ThreatHuntID "cccswdc-dsfsdsdf-sdsdfsf"
This example returns a list of all the files matched/found in threat hunt ID specified.
