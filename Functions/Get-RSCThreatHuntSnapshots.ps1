...
<#
.SYNOPSIS
A Rubrik Security Cloud (RSC) Reporting Module Function that returns a list of all snapshots identified within the threat hunt ID specified. 
...
The Threat Hunt ID on which the snapshots you want to query, use Get-RSCThreatHunts to obtain.
