...
<#
.SYNOPSIS
A Rubrik Security Cloud (RSC) Reporting Module Function returning a list of all objects configured on a threat hunt.
...
.EXAMPLE
Get-RSCThreatHuntObjects -ThreatHuntID "cccswdc-dsfsdsdf-sdsdfsf"
This example returns a list of all threat hunts for the ID specified.
