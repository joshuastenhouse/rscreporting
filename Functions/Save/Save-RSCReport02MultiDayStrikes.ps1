################################################
# Function - Save-RSCReport02MultiDayStrikes - Saving RSC Report
################################################
Function Save-RSCReport02MultiDayStrikes {
...
Set the name of the report, by default uses "Rubrik Multi-Day Strikes"
