...
<#
.SYNOPSIS
A Rubrik Security Cloud (RSC) Reporting Module Function returning a list of all VMware tag assignments in all vCenters.
...
ELSE
{
$VMProtectionDateUTC = $VMProtectionDateUNIX
$VMNoteCreatedUTC = $VMNoteCreatedUNIX
}
# SLA info
...
$Object | Add-Member -MemberType NoteProperty -Name "Tag" -Value $VMTagName
$Object | Add-Member -MemberType NoteProperty -Name "TagID" -Value $VMTagID
