################################################
# Function - Get-RSCAWSDynamoDBTagAssignments - Getting All AWS Dynamo DB Tags connected to RSC
################################################
Function Get-RSCAWSDynamoDBTagAssignments {
...
$Object | Add-Member -MemberType NoteProperty -Name "Cloud" -Value "AWSDynamoDB"
