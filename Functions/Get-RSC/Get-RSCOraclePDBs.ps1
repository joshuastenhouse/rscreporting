################################################
# Function - Get-RSCOraclePDBs - Getting all Microsoft SQL Databases connected to the RSC instance
################################################
function Get-RSCOraclePDB {

    <#
.SYNOPSIS
A Rubrik Security Cloud (RSC) Reporting Module Function returning a list of all Oracle PDBs.
