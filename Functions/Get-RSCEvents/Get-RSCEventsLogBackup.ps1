################################################
# Function - Get-RSCEventsLogBackup - Getting all RSC Log Backup events
################################################
Function Get-RSCEventsLogBackup {

<#
.SYNOPSIS
Returns all RSC log backup events within the time frame specified, default is 24 hours with no parameters.
