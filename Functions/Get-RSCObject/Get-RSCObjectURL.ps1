...
# Cluster
# /clusters/be8cb1b6-c0d6-43d9-af09-950e26cf6e4a/overview
IF ($ObjectType -eq "Cluster"){$RSCObjectURL = $RSCURL + "/clusters/" + $ObjectID + "/overview"}

# SLA domain
# /sla/details/41450dc4-1021-448e-9861-efe6a7699624
IF ($ObjectType -eq "SLADomain"){$RSCObjectURL = $RSCURL + "/sla/details/" + $ObjectID}

# VMware VM
# /inventory_hierarchy/vsphere/144c6e1d-a060-5305-a5d6-81d8d8e6edca/overview
...
# https://rubrik.com/inventory_hierarchy/O365SharepointList/3715b31b-885c-4b85-8a4e-0fafe200f2a0/overview
...
# /inventory_hierarchy/m365SharepointSiteCollection/7cda68be-4525-4e5c-a39b-ce2a70f1a3cf/overview
IF ($ObjectType -eq "Site Pages"){$RSCObjectURL = $RSCURL + "/inventory_hierarchy/m365SharepointSiteCollection/" + $ObjectID + "/overview"}

# 0365 Teams
# /inventory_hierarchy/o365Teams/91db54d1-af05-4848-9549-84b780dedc9a/overview
IF ($ObjectType -eq "o365Teams"){$RSCObjectURL = $RSCURL + "/inventory_hierarchy/o365Teams/" + $ObjectID + "/overview"}

# 0365 User
# /inventory_hierarchy/o365exchange/420eb055-e898-4896-92ce-5cd562c34783/overview
...
# /inventory_hierarchy/awsNativeEc2Instance/07e1d738-33f7-48fb-8282-3eb25fadfd8d/overview
...
# AWS S3Bucket
# /inventory_hierarchy/awsNativeS3Bucket/c6cf0547-5949-4133-82c4-cf370aba5d89/overview
...
# /inventory_hierarchy/AwsNativeEbsVolume/07e1d738-33f7-48fb-8282-3eb25fadfd8d/overview
...
# /inventory_hierarchy/awsNativeRdsInstance/61e86f05-31af-48a9-ae02-a39bb1ff0b3c/overview
...
# /inventory_hierarchy/aws/EC2/account/ac0b7687-291e-459f-84aa-901f0777ab1f
IF ($ObjectType -eq "awsEC2account"){$RSCObjectURL = $RSCURL + "/inventory_hierarchy/aws/EC2/account/" + $ObjectID}

# AWS RDS account view
# /inventory_hierarchy/aws/RDS/account/f8d22d77-8d23-4be3-bdc7-3a31774bdd2d
IF ($ObjectType -eq "awsRDSaccount"){$RSCObjectURL = $RSCURL + "/inventory_hierarchy/aws/RDS/account/" + $ObjectID}

# Azure AzureNativeVm
# /inventory_hierarchy/AzureNativeVm/0f052c97-0ceb-41e3-ac6f-4c663b5735b4/overview
...
# Azure SQL database
# /inventory_hierarchy/azure_sql/db/databases/04e88f39-5982-4c6e-9cca-f238a3c32446/overview
IF ($ObjectType -eq "AZURE_SQL_DATABASE_DB"){$RSCObjectURL = $RSCURL + "/inventory_hierarchy/azure_sql/db/databases/" + $ObjectID + "/overview"}

# Azure VM sub
#/inventory_hierarchy/azure/subscriptions/46341153-5307-4ee4-8b8b-323880589ad9/virtual_machines
...
# Azure SQL sub
# /inventory_hierarchy/azure_sql/db/subscriptions/29302ac7-34c3-4691-9da4-175b12dc53cd/databases
...
# /inventory_hierarchy/azure/blob/subscriptions/29302ac7-34c3-4691-9da4-175b12dc53cd
...
# GCP Project
# /inventory_hierarchy/gcp/project/31b683d4-1c5a-43e4-80d0-1805bc31af8c/gce_instances
IF ($ObjectType -eq "gcpProject"){$RSCObjectURL = $RSCURL + "/gcp/project/" + $ObjectID + "/gce_instances"}

# GCP GcpNativeDisk
# /inventory_hierarchy/gcpNativeGceInstance/71fe9073-421c-4892-b96e-a9dffac05f24/overview
IF ($ObjectType -eq "GcpNativeDisk"){$RSCObjectURL = $RSCURL + "/inventory_hierarchy/gcpNativeGceInstance/" + $ObjectID + "/overview"}

# ShareFileset
# /inventory_hierarchy/ShareFileset/71fe9073-421c-4892-b96e-a9dffac05f24/overview
...
# AWSDynamoDB
# /inventory_hierarchy/azure_ad/f07e6ce6-2536-40d0-8509-ed6d8c78034f/overview
IF ($ObjectType -eq "AWSDynamoDB"){$RSCObjectURL = $RSCURL + "/inventory_hierarchy/aws/dynamodb/tables/" + $ObjectID + "/overview"}
