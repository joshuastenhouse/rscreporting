...
<#
.SYNOPSIS
Collects the event types and writes them to an existing MS SQL databse of your choosing, if not specified the default table name RSCEvents will created (so you don't need to know the required structure).
...
.EXAMPLE
Write-RSCEvents -SQLInstance "localhost" -SQLDB "YourDBName" -DaysToCapture 30
